      ...
      <div className="col1 flex justify-center items-center flex-col mt-20 text-gray-900">
        <div className='flex flex-col gap-5 my-8'>
          ...
          <div className="item">
            ...
            <div className='mx-4'>
              <input value={handle || ""} onChange={e=>{sethandle(e.target.value)}} className='px-4 py-2 my-2 outline outline-pink-500  rounded-full'
          ...
          <div className="item">
            ...
            {links && links.map((item, index)=>{
              ...
              <input value={item.link || ""} onChange={e=>{handleChange(index, e.target.value, item.linktext)}} className='px-4 py-2 mx-2 my-2 outline outline-pink-500 rounded-full'
