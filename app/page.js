...
export default function Home() {
  ...
  return (
    ...
    <div className="flex mt-20 justify-center flex-col ml-[10vw] gap-3">
      ...
      <div className="input flex gap-2">
        <input value={text} onChange={(e)=> setText(e.target.value)} className="px-2 border border-gray-200 text-white focus:outline-green-800 rounded-md" type="text" placeholder="Enter your Handle" />
        <button onClick={()=> createTree()} className="bg-pink-300 hover:bg-pink-400 transition:background-color duration-300 rounded-full px-4 py-2 font-semibold">Claim your Bittree</button>
      </div>
    </div>
